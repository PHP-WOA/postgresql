...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    STDOUT = 629,                  /* STDOUT  */
    STORAGE = 630,                 /* STORAGE  */
    STRICT_P = 631,                /* STRICT_P  */
    STRIP_P = 632,                 /* STRIP_P  */
    SUBSCRIPTION = 633,            /* SUBSCRIPTION  */
    SUBSTRING = 634,               /* SUBSTRING  */
    SYMMETRIC = 635,               /* SYMMETRIC  */
    SYSID = 636,                   /* SYSID  */
    SYSTEM_P = 637,                /* SYSTEM_P  */
    TABLE = 638,                   /* TABLE  */
    TABLES = 639,                  /* TABLES  */
    TABLESAMPLE = 640,             /* TABLESAMPLE  */
    TABLESPACE = 641,              /* TABLESPACE  */
    TEMP = 642,                    /* TEMP  */
    TEMPLATE = 643,                /* TEMPLATE  */
    TEMPORARY = 644,               /* TEMPORARY  */
    TEXT_P = 645,                  /* TEXT_P  */
    THEN = 646,                    /* THEN  */
    TIES = 647,                    /* TIES  */
    TIME = 648,                    /* TIME  */
    TIMESTAMP = 649,               /* TIMESTAMP  */
    TO = 650,                      /* TO  */
    TRAILING = 651,                /* TRAILING  */
    TRANSACTION = 652,             /* TRANSACTION  */
    TRANSFORM = 653,               /* TRANSFORM  */
    TREAT = 654,                   /* TREAT  */
    TRIGGER = 655,                 /* TRIGGER  */
    TRIM = 656,                    /* TRIM  */
    TRUE_P = 657,                  /* TRUE_P  */
    TRUNCATE = 658,                /* TRUNCATE  */
    TRUSTED = 659,                 /* TRUSTED  */
    TYPE_P = 660,                  /* TYPE_P  */
    TYPES_P = 661,                 /* TYPES_P  */
    UNBOUNDED = 662,               /* UNBOUNDED  */
    UNCOMMITTED = 663,             /* UNCOMMITTED  */
    UNENCRYPTED = 664,             /* UNENCRYPTED  */
    UNION = 665,                   /* UNION  */
    UNIQUE = 666,                  /* UNIQUE  */
    UNKNOWN = 667,                 /* UNKNOWN  */
    UNLISTEN = 668,                /* UNLISTEN  */
    UNLOGGED = 669,                /* UNLOGGED  */
    UNTIL = 670,                   /* UNTIL  */
    UPDATE = 671,                  /* UPDATE  */
    USER = 672,                    /* USER  */
    USING = 673,                   /* USING  */
    VACUUM = 674,                  /* VACUUM  */
    VALID = 675,                   /* VALID  */
    VALIDATE = 676,                /* VALIDATE  */
    VALIDATOR = 677,               /* VALIDATOR  */
    VALUE_P = 678,                 /* VALUE_P  */
    VALUES = 679,                  /* VALUES  */
    VARCHAR = 680,                 /* VARCHAR  */
    VARIADIC = 681,                /* VARIADIC  */
    VARYING = 682,                 /* VARYING  */
    VERBOSE = 683,                 /* VERBOSE  */
    VERSION_P = 684,               /* VERSION_P  */
    VIEW = 685,                    /* VIEW  */
    VIEWS = 686,                   /* VIEWS  */
    VOLATILE = 687,                /* VOLATILE  */
    WHEN = 688,                    /* WHEN  */
    WHERE = 689,                   /* WHERE  */
    WHITESPACE_P = 690,            /* WHITESPACE_P  */
    WINDOW = 691,                  /* WINDOW  */
    WITH = 692,                    /* WITH  */
    WITHIN = 693,                  /* WITHIN  */
    WITHOUT = 694,                 /* WITHOUT  */
    ...
    WRITE = 697,                   /* WRITE  */
    XML_P = 698,                   /* XML_P  */
    XMLATTRIBUTES = 699,           /* XMLATTRIBUTES  */
    XMLCONCAT = 700,               /* XMLCONCAT  */
    XMLELEMENT = 701,              /* XMLELEMENT  */
    XMLEXISTS = 702,               /* XMLEXISTS  */
    XMLFOREST = 703,               /* XMLFOREST  */
    XMLNAMESPACES = 704,           /* XMLNAMESPACES  */
    XMLPARSE = 705,                /* XMLPARSE  */
    XMLPI = 706,                   /* XMLPI  */
    XMLROOT = 707,                 /* XMLROOT  */
    XMLSERIALIZE = 708,            /* XMLSERIALIZE  */
    XMLTABLE = 709,                /* XMLTABLE  */
    YEAR_P = 710,                  /* YEAR_P  */
    YES_P = 711,                   /* YES_P  */
    ZONE = 712,                    /* ZONE  */
    NOT_LA = 713,                  /* NOT_LA  */
    NULLS_LA = 714,                /* NULLS_LA  */
    WITH_LA = 715,                 /* WITH_LA  */
    POSTFIXOP = 716,               /* POSTFIXOP  */
    UMINUS = 717                   /* UMINUS  */
  };
...
#line 570 "src/backend/parser/gram.h"
